plot_confidence_map <- function(data, sensitivity_column,Title,Name,custom_boundaries,custom_labels,additional_shapefiles = NULL, additional_colors = NULL, additional_border_patterns = NULL,x_limits = NULL, y_limits = NULL) {
