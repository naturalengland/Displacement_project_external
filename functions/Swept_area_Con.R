SweptArea_Con <- function(coords, scale_limits, legend_title, x_limits, y_limits, additional_shapefiles = NULL, additional_colors = NULL, additional_border_patterns = NULL, breaks, labels) {
  ...
  grd <- grd %>%
    mutate(TR_AREA = ifelse(data1 < 3, NA, TR_AREA))
