SweptArea <- function(coords, scale_limits, legend_title, x_limits, y_limits, additional_shapefiles = NULL, additional_colors = NULL, additional_border_patterns = NULL) {
  ...
  coords$TR_AREA <- (coords$TIME) * (coords$LE_WIDTH / 1000) * (coords$SI_SP * 1.852)
